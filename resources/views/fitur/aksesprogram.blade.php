   ...
   <div class="container">
    <div class="row">
        ...
        <div class="col-3 text-center">
            <button  type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#aksesProgram" id="btn-aksesprogram">Ajukan</button>
        </div>
    </div>
   </div>
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                            ...
                            <table class="table mb-0 text-center table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><button  type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#detail" id="btn-detail">Detail</button></td>
                                    </tr>
                        ...
                        <!-- Modal -->
                        <div class="modal fade" id="aksesProgram" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        <div class="modal fade" id="detail" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                <h1 class="modal-title fs-5" id="exampleModalLabel">Detail data pengajuan akses program</h1>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <form class="form form-horizontal">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="">
                                                    <div class="form-group">
                                                        <div class="position-relative">
                                                            <div class="form">
                                                                <textarea readonly class="form-control" placeholder="" id="floatingTextarea2" style="height: 100px"></textarea>
                                                              </div>
                                                        </div>
                                                    </div>
                                                </div>
