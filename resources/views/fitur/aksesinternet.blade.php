...
<header class=" d-flex">
    ...
    <div class="button">
        <button  type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" id="btn-sewazoom">Ajukan Akses</button>
     </div>
                                        ...
                                        <div class="form-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group has-icon-left">
                                                        <div class="position-relative">
                                                            <input type="text" class="form-control" placeholder="Keperluan Email">
                                                            <div class="form-control-icon">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group has-icon-left">
                                                        <div class="position-relative">
                                                            <input type="text" class="form-control" placeholder="Keperluan Browsing">
                                                            <div class="form-control-icon">
