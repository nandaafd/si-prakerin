   ...
   <div class="container">
    <div class="row">
        ...
        <div class="col-3 text-center">
            <button  type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#revisiData" id="btn-revisidata">Revisi Data</button>
        </div>
    </div>
   </div>
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        ...
                        <!-- Modal -->
                        <div class="modal fade" id="revisiData" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
